...
class BoardMovementTest {
    ...
    void testMovePiecesUp() {
        ...
        assertEquals(2, board.getTable()[0][0]);
        assertEquals(2, board.getTable()[0][1]);
    ...
    void testMoveInvalidException() {
        Board board = Board.defaltBoard();
        assertThrows(MovimentException.class, () -> BoardMovement.movePieces(KeyDirectionEnum.UP, null, board));
    }
}
